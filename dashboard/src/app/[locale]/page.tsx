...
import { Activity, Settings, Shield, TrendingUp } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Real-time monitoring of your API protection</CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm">Rate limit configuration updated</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm">High request volume detected</p>
